...
const Footer = () => {
    return (
        <footer className="footer py-5 mt-5 shadow-lg" style={{backgroundColor: "#1C4A5B", color: "#Ffff"}}>
                ...
                <div className="row toColumnPlease">
                    <div className="col-lg-4 col-md-6 mx-lg-0 mx-auto">
                        ...
                        <ul className="list-group list-group-flush text-lg-right text-center pr-0 ">
                            ...
                            <li className="list-group">
                                <Link href="/home">
                                    <a className="nav-link">تسجيل دخول</a>
                                </Link>
                            </li>
                            <li className="list-group">
                                <Link href="/home">
                                    <a className="nav-link">تسجيل جديد</a>
                                </Link>
                            </li>
                            <li className="list-group">
                                <Link href="/home">
                    ...
                    <div className="col-lg-4 col-12 text-right text-center mx-lg-0 mx-auto">
                        ...
                        <p className="lead mt-4 text-lg-right text-center">
                            جميع الحقوق محفوظة
                            فريق عمل
                            <span className="badge badge-warning mx-2 text-capitalize">think first</span>
